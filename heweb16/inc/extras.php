...
function my_theme_add_editor_styles() {
    add_editor_style( get_template_directory_uri() . '/assets/css/heweb-editor.css' );
}
...
add_filter('embed_oembed_html', 'brvry_embed_oembed_html', 99, 4);
function brvry_embed_oembed_html($html, $url, $attr, $post_id) {
