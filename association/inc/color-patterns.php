 ...
 */
function association_custom_colors_css() {
	$hue = absint( get_theme_mod( 'colorscheme_hue', 250 ) );

	/**
	 * Filter Association default saturation level.
	 *
	 * @since Association 1.0
	 *
	 * @param $saturation integer
	 */
	$saturation = absint( apply_filters( 'association_custom_colors_saturation', 50 ) );
...
.colors-custom.page:not(.association-front-page) .entry-title,
...
.colors-custom .association-panel .recent-posts .entry-header .edit-link {
...
.colors-custom.association-front-page .panel-content .recent-posts article,
...
.colors-custom.association-front-page article:not(.has-post-thumbnail):not(:first-child),
...
@media screen and (min-width: 48em) {
	...
	/**
	 * Filters Association custom colors CSS.
	 *
	 * @since Association 1.0
	 *
	 ...
	 */
	return apply_filters( 'association_custom_colors_css', $css, $hue, $saturation );
}
